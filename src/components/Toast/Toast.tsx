    ...
    <>
      {showing && (
        <PanGestureHandler onGestureEvent={gestureHandler}>
          <Animated.View style={[styles.toastContainer, toastStyles[toastType!]?.container, animatedTopStyles]}>
            <Image source={toastStyles[toastType!]?.icon} style={styles.toastIcon} />
            <Text style={[styles.toastText, toastStyles[toastType!]?.text]}>{toastText}</Text>
          </Animated.View>
        </PanGestureHandler>
      )}
    </>
