  ...
  return (
    <View style={styles.wrapper}>
      {loading ? (
        ...
        <Formik validationSchema={emailValidationSchema} initialValues={{ email: '' }} onSubmit={handleSubmit}>
            ...
            <>
              <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.loginButton}>
                  <Text disabled={!isValid} style={styles.loginText} onPress={handleSubmit}>
                    Send email
                  </Text>
                </TouchableOpacity>
              </View>
