        ...
        <SafeAreaView>
            ...
            <View style={{height: "95%", justifyContent: 'space-between', flexDirection: 'column'}}>
                <ScrollView style={{position: 'relative'}} showsVerticalScrollIndicator={false}>
                    ...
                    {post.image ? (
                        <View style={{ position: 'absolute', top: 125, left: 8, height: '75%', width: 1, backgroundColor: '#00000017' }} />
                    ) : (
                        <View style={{ position: 'absolute', top: 12, left: 5, height: '60%', width: 1, backgroundColor: '#00000017' }} />
                    )}
