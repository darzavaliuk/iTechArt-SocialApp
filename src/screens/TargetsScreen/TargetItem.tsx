...
export const TargetItem = ({item, itemIndex}) => {
    ...
    return (
        <TouchableOpacity key={itemIndex} onPress={pressChange}
                          style={{
            ...
            <View style={{flexDirection: "row", alignItems: "center"}}>
                ...
                >
                    <Text style={{
                        ...
                        marginLeft: 20,
                        // fontWeight: "bold"
                    }}>{item.name?.length > 8 ? item.name.slice(0, 8) + "..." : item.name}</Text>
            ...
            {isActine && item.subTargets.map((el) => {
                    return (
            ...
            {isActine &&
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => setIsToday(true)} style={{marginHorizontal: 10}}><Image
                        source={require('../../../assets/images/time.png')}
                        style={{width: 25, height: 27}}/></TouchableOpacity>
                    <TouchableOpacity onPress={() => setIsToday(false)} style={{marginHorizontal: 10}}><Image
