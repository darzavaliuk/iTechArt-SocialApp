    ...
    return (
        <SafeAreaView style={{ flex: 1}}>
            <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between' }}>
                ...
                <View style={{ position: 'absolute', bottom: 8, flexDirection: 'row', width: '100%', justifyContent: 'center', backgroundColor: 'white', height: 70, alignItems: 'center' }}>
                    <TouchableOpacity
                        style={{ width: '92%', backgroundColor: '#00000026', height: 45, borderRadius: 40, flexDirection: 'row', alignItems: 'center' }}
                        onPress={() =>
