...
import {URI} from "../../../URI";
import {
    addLikes, addLikesToRepliesReply,
    addLikesToReply,
    removeLikes,
    ...
    return (
        ...
        >
            <View style={{ position: 'relative' }}>
                ...
                <View style={item.image ? { position: 'absolute', top: 14, left: 5, height: '90%', width: 1, backgroundColor: '#00000017' } : { position: 'absolute', top: 12, left: 5, height: '60%', width: 1, backgroundColor: '#00000017' }} />
