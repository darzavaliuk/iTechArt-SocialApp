            ...
            <>
              <Animated.View style={styles.container}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.forgetText} onPress={() => navigation.navigate('ForgetPassword' as never)}>
                    Forget password?
                  </Text>
                </View>
              </Animated.View>
              <View style={{ display: 'flex', alignItems: 'center' }}>
                <TouchableOpacity style={styles.loginButton}>
                  <Text style={styles.loginText} disabled={!isValid} onPress={handleSubmit}>
                    Login
                  </Text>
                </TouchableOpacity>

                <Text style={styles.signUpText} onPress={() => navigation.navigate('Signup' as never)}>
